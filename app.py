...
with cflt2: alt_wp = st.number_input("Altitude default (ft) p/ WPs", 0.0, 18000.0, 3000.0, step=100.0)
...
if not results.empty:
    ...
    picked = st.multiselect("Seleciona p/ adicionar:", labels)
...
def _add_text(map_obj, lat, lon, text, size_px=22, color="#FFD700", halo=True):
    weight="700"; shadow = "text-shadow:-1px -1px 0 #fff,1px -1px 0 #fff,-1px 1px 0 #fff,1px 1px 0 #fff;" if halo else ""
